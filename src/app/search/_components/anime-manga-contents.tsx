...
interface AnimeMangaContentsProps {
  data: AnimeMainPage[];
}

const AnimeMangaContents = ({ data }: AnimeMangaContentsProps) => {
    ...
    >
      {data.map((data) => (
        <div key={data.id} className="px-2">
          ...
          <h3 className="mr-2 max-w-[150px] space-x-4 px-2 py-2 text-sm font-semibold text-[#060719] dark:text-[#e6e7f9]">
...
export default AnimeMangaContents;
